...
(custom-set-faces
 ...
 '(rainbow-delimiters-depth-2-face ((t (:foreground "MediumPurple2"))))
 '(rainbow-delimiters-depth-3-face ((t (:foreground "burlywood2"))))
 '(rainbow-delimiters-depth-4-face ((t (:foreground "sea green"))))
 '(rainbow-delimiters-depth-5-face ((t (:foreground "MediumPurple2"))))
 '(rainbow-delimiters-depth-6-face ((t (:foreground "burlywood2"))))
 '(rainbow-delimiters-depth-7-face ((t (:foreground "sea green"))))
 '(rainbow-delimiters-depth-8-face ((t (:foreground "MediumPurple2"))))
 '(rainbow-delimiters-depth-9-face ((t (:foreground "burlywood2")))))
